# 电感与RL电路 / Inductance & RL circuits

<!-- TeachAny KP: kp_id=kp-physics-ap-c-inductance node_id=physics-ap-c-inductance subject=physics-c stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-c-inductance` |
| node_id | `physics-ap-c-inductance` |
| 知识点 | 电感与RL电路 |
| 英文名 | Inductance & RL circuits |
