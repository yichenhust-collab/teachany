# 19 能量学进阶（晶格能/Born-Haber 循环） / 19 Chemical energetics (A2)

<!-- TeachAny KP: kp_id=kp-chem-cam-al-energetics-a2 node_id=chem-cam-al-energetics-a2 subject=chemistry stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chem-cam-al-energetics-a2` |
| node_id | `chem-cam-al-energetics-a2` |
| 知识点 | 19 能量学进阶（晶格能/Born-Haber 循环） |
| 英文名 | 19 Chemical energetics (A2) |
| 学科 | 化学 (chemistry) |
| 学段 | al (al) |
| 年级 | 13 |
| 课标系统 | 剑桥国际课程 |
| 领域 | A2 进阶课程 Advanced Chemistry |
