# 运动学(微积分) / Kinematics with calculus

<!-- TeachAny KP: kp_id=kp-physics-ap-c-kinematics-calc node_id=physics-ap-c-kinematics-calc subject=physics-c stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-c-kinematics-calc` |
