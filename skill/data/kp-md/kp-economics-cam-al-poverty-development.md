# 贫困与发展 / Poverty & development

<!-- TeachAny KP: kp_id=kp-economics-cam-al-poverty-development node_id=economics-cam-al-poverty-development subject=economics stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-economics-cam-al-poverty-development` |
| node_id | `economics-cam-al-poverty-development` |
| 知识点 | 贫困与发展 |
| 英文名 | Poverty & development |
| 学科 | 经济 (economics) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
| 领域 | 发展经济学 / Development Economics / Development Economics |
...
- `economics-cam-al-development-indicators`
...
2.1.3 determinants of demand
2.1.4 determinants of supply
2.1.5 causes of a shift in the demand curve ...；2.4 The interaction of demand and supply
2.4.1 definition of market equilibrium and disequilibrium
2.4.2 effects of shifts in demand and supply curves on equilibrium price and quantity
2.4.3 relations...
