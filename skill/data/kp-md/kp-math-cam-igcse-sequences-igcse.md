...
<!-- TeachAny KP: kp_id=kp-math-cam-igcse-sequences-igcse node_id=math-cam-igcse-sequences-igcse subject=math stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-cam-igcse-sequences-igcse` |
| node_id | `math-cam-igcse-sequences-igcse` |
| 知识点 | 数列 |
| 英文名 | Sequences |
| 学科 | 数学 (math) |
| 学段 | IGCSE (igcse) |
