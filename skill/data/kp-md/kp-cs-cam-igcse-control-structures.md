# 选择与循环 / Control structures

<!-- TeachAny KP: kp_id=kp-cs-cam-igcse-control-structures node_id=cs-cam-igcse-control-structures subject=cs stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-cam-igcse-control-structures` |
| node_id | `cs-cam-igcse-control-structures` |
| 知识点 | 选择与循环 |
| 英文名 | Control structures |
| 学科 | 计算机 (cs) |
| 学段 | IGCSE (igcse) |
| 年级 | 10 |
| 课标系统 | 剑桥国际课程 |
...
(i) positive denary and positive binary
(ii) positive denary and positive hexadecimal
(iii) positive hexadecimal ...；3 Understand how and why hexadecimal is used as a beneficial method of data representation
