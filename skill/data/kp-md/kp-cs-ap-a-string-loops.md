...
<!-- TeachAny KP: kp_id=kp-cs-ap-a-string-loops node_id=cs-ap-a-string-loops subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-string-loops` |
| node_id | `cs-ap-a-string-loops` |
| 知识点 | 字符串遍历 |
| 英文名 | String traversal |
| 学科 | 计算机 (cs) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 大学先修 |
