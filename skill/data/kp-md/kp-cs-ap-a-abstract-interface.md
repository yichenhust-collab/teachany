# 抽象类与接口 / Abstract & interfaces

<!-- TeachAny KP: kp_id=kp-cs-ap-a-abstract-interface node_id=cs-ap-a-abstract-interface subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-abstract-interface` |
| node_id | `cs-ap-a-abstract-interface` |
| 知识点 | 抽象类与接口 |
| 英文名 | Abstract & interfaces |
| 学科 | 计算机 (cs) |
| 学段 | 高中 (high) |
| 年级 | 12 |
| 课标系统 | AP 大学先修 |
| 领域 | Unit 9-10 继承与递归 Inheritance & Recursion |
