# 圆的定理 / Circle theorems

<!-- TeachAny KP: kp_id=kp-math-cam-igcse-circle-geom node_id=math-cam-igcse-circle-geom subject=math stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-cam-igcse-circle-geom` |
| node_id | `math-cam-igcse-circle-geom` |
| 知识点 | 圆的定理 |
| 英文名 | Circle theorems |
| 学科 | 数学 (math) |
| 学段 | IGCSE (igcse) |
