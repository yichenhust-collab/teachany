...
<!-- TeachAny KP: kp_id=kp-economics-cam-igcse-elasticity-igc node_id=economics-cam-igcse-elasticity-igc subject=economics stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-economics-cam-igcse-elasticity-igc` |
| node_id | `economics-cam-igcse-elasticity-igc` |
| 知识点 | 弹性 |
| 英文名 | Elasticity |
| 学科 | 经济 (economics) |
| 学段 | IGCSE (igcse) |
...
- `economics-cam-igcse-demand-supply-igc`
