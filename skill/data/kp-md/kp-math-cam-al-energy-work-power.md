# M1.4 功、能量、功率 / M1.4 Energy, work, power

<!-- TeachAny KP: kp_id=kp-math-cam-al-energy-work-power node_id=math-cam-al-energy-work-power subject=math stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-cam-al-energy-work-power` |
| node_id | `math-cam-al-energy-work-power` |
| 知识点 | M1.4 功、能量、功率 |
| 英文名 | M1.4 Energy, work, power |
| 学科 | 数学 (math) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
