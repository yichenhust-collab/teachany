...
<!-- TeachAny KP: kp_id=kp-math-ib-dp-binomial node_id=math-ib-dp-binomial subject=math-aa stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-dp-binomial` |
| node_id | `math-ib-dp-binomial` |
| 知识点 | 二项式定理 |
