# 热能转移（热容/相变/潜热） / Thermal energy transfers

<!-- TeachAny KP: kp_id=kp-phy-ib-dp-thermal-energy node_id=phy-ib-dp-thermal-energy subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-thermal-energy` |
| node_id | `phy-ib-dp-thermal-energy` |
| 知识点 | 热能转移（热容/相变/潜热） |
| 英文名 | Thermal energy transfers |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 11 |
| 课标系统 | IB 国际文凭 |
