# S1.5 正态分布 / S1.5 Normal distribution

<!-- TeachAny KP: kp_id=kp-math-cam-al-normal-distribution node_id=math-cam-al-normal-distribution subject=math stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-cam-al-normal-distribution` |
| node_id | `math-cam-al-normal-distribution` |
| 知识点 | S1.5 正态分布 |
| 英文名 | S1.5 Normal distribution |
| 学科 | 数学 (math) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
...
- `math-cam-al-stats-representation`
