# 引力场与轨道运动 / Gravitational fields

<!-- TeachAny KP: kp_id=kp-phy-ib-dp-gravitational-fields node_id=phy-ib-dp-gravitational-fields subject=physics stage=dp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-ib-dp-gravitational-fields` |
| node_id | `phy-ib-dp-gravitational-fields` |
| 知识点 | 引力场与轨道运动 |
| 英文名 | Gravitational fields |
| 学科 | 物理 (physics) |
| 学段 | IB-DP（高中） (dp) |
| 年级 | 12 |
| 课标系统 | IB 国际文凭 |
