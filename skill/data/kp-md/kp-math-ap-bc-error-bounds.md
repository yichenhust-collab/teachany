...
<!-- TeachAny KP: kp_id=kp-math-ap-bc-error-bounds node_id=math-ap-bc-error-bounds subject=calculus stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ap-bc-error-bounds` |
| node_id | `math-ap-bc-error-bounds` |
| 知识点 | 误差估计 |
| 英文名 | Error bounds |
| 学科 | 微积分 (calculus) |
| 学段 | 高中 (high) |
