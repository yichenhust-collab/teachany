...
<!-- TeachAny KP: kp_id=kp-cs-ap-a-variables-expressions node_id=cs-ap-a-variables-expressions subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-variables-expressions` |
| node_id | `cs-ap-a-variables-expressions` |
| 知识点 | 变量与表达式 |
| 英文名 | Variables & expressions |
| 学科 | 计算机 (cs) |
| 学段 | 高中 (high) |
| 年级 | 10 |
| 课标系统 | AP 大学先修 |
