# 无理数与根式（延伸） / Surds (Extended)

<!-- TeachAny KP: kp_id=kp-math-ib-myp-myp-surds node_id=math-ib-myp-myp-surds subject=mathematics stage=myp -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ib-myp-myp-surds` |
| node_id | `math-ib-myp-myp-surds` |
| 知识点 | 无理数与根式（延伸） |
| 英文名 | Surds (Extended) |
| 学科 | 数学 (mathematics) |
| 学段 | IB-MYP（初中） (myp) |
...
Solution of quadratic equations and inequalities.
The quadratic formula.
The discriminant Δ=b2−4ac and the nature of the roots, that is, two d...
