...
<!-- TeachAny KP: kp_id=kp-chemistry-cam-igcse-energetics node_id=chemistry-cam-igcse-energetics subject=chemistry stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-cam-igcse-energetics` |
| node_id | `chemistry-cam-igcse-energetics` |
| 知识点 | 热化学 |
| 英文名 | Energetics |
| 学科 | 化学 (chemistry) |
| 学段 | IGCSE (igcse) |
