# 23 量子物理（光电效应/能级） / 23 Quantum physics

<!-- TeachAny KP: kp_id=kp-phy-cam-al-quantum-physics node_id=phy-cam-al-quantum-physics subject=physics stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-phy-cam-al-quantum-physics` |
| node_id | `phy-cam-al-quantum-physics` |
| 知识点 | 23 量子物理（光电效应/能级） |
| 英文名 | 23 Quantum physics |
| 学科 | 物理 (physics) |
| 学段 | al (al) |
| 年级 | 13 |
| 课标系统 | 剑桥国际课程 |
...
Candidates should be able to:
1 understand that mass is the property of an object that resists change in motion
2 recall F = ma and solve problems using it, un...；3.3 Linear momentum and its conservation
Candidates should be able to:
1 state the principle of conservation of momentum
2 apply the principle of conservation of momentum to solve simple problems, inc...
