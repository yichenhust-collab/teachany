...
<!-- TeachAny KP: kp_id=kp-chemistry-cam-igcse-polymers node_id=chemistry-cam-igcse-polymers subject=chemistry stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-cam-igcse-polymers` |
| node_id | `chemistry-cam-igcse-polymers` |
| 知识点 | 聚合物 |
| 英文名 | Polymers |
| 学科 | 化学 (chemistry) |
| 学段 | IGCSE (igcse) |
