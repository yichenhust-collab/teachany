# 类与方法 / Writing classes

<!-- TeachAny KP: kp_id=kp-cs-ap-a-class-basics node_id=cs-ap-a-class-basics subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-class-basics` |
| node_id | `cs-ap-a-class-basics` |
| 知识点 | 类与方法 |
| 英文名 | Writing classes |
| 学科 | 计算机 (cs) |
| 学段 | 高中 (high) |
