...
<!-- TeachAny KP: kp_id=kp-physics-ap-1-pendulum node_id=physics-ap-1-pendulum subject=physics-1 stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-1-pendulum` |
| node_id | `physics-ap-1-pendulum` |
| 知识点 | 单摆 |
| 英文名 | Pendulum |
