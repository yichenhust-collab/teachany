# 牛顿定律(微积分) / Newton's laws with calculus

<!-- TeachAny KP: kp_id=kp-physics-ap-c-newton-calc node_id=physics-ap-c-newton-calc subject=physics-c stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-c-newton-calc` |
| node_id | `physics-ap-c-newton-calc` |
| 知识点 | 牛顿定律(微积分) |
| 英文名 | Newton's laws with calculus |
