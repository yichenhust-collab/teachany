# 电容器与介质 / Capacitors & dielectrics

<!-- TeachAny KP: kp_id=kp-physics-ap-c-capacitors node_id=physics-ap-c-capacitors subject=physics-c stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-ap-c-capacitors` |
| node_id | `physics-ap-c-capacitors` |
| 知识点 | 电容器与介质 |
| 英文名 | Capacitors & dielectrics |
...
- `physics-ap-c-electric-potential`
