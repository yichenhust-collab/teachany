# 24 过渡金属（配位化合物/催化） / 24 Transition elements

<!-- TeachAny KP: kp_id=kp-chem-cam-al-transition-metals node_id=chem-cam-al-transition-metals subject=chemistry stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chem-cam-al-transition-metals` |
| node_id | `chem-cam-al-transition-metals` |
| 知识点 | 24 过渡金属（配位化合物/催化） |
| 英文名 | 24 Transition elements |
| 学科 | 化学 (chemistry) |
| 学段 | al (al) |
| 年级 | 13 |
| 课标系统 | 剑桥国际课程 |
