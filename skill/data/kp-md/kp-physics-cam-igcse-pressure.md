...
<!-- TeachAny KP: kp_id=kp-physics-cam-igcse-pressure node_id=physics-cam-igcse-pressure subject=physics stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-cam-igcse-pressure` |
| node_id | `physics-cam-igcse-pressure` |
| 知识点 | 压强 |
| 英文名 | Pressure |
| 学科 | 物理 (physics) |
| 学段 | IGCSE (igcse) |
...
- `physics-cam-igcse-forces-newton`
