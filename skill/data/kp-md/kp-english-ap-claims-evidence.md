# 主张与证据 / Claims & evidence

<!-- TeachAny KP: kp_id=kp-english-ap-claims-evidence node_id=english-ap-claims-evidence subject=english stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-ap-claims-evidence` |
| node_id | `english-ap-claims-evidence` |
| 知识点 | 主张与证据 |
| 英文名 | Claims & evidence |
| 学科 | 英语 (english) |
| 学段 | 高中 (high) |
