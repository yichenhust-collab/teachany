# 14 烃（烷烃/烯烃） / 14 Hydrocarbons

<!-- TeachAny KP: kp_id=kp-chem-cam-al-hydrocarbons node_id=chem-cam-al-hydrocarbons subject=chemistry stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chem-cam-al-hydrocarbons` |
| node_id | `chem-cam-al-hydrocarbons` |
| 知识点 | 14 烃（烷烃/烯烃） |
| 英文名 | 14 Hydrocarbons |
| 学科 | 化学 (chemistry) |
| 学段 | al (al) |
...
Learning outcomes
Candidates should be able to:
1 understand that atoms are mostly empty space surrounding a very small, dense nucleus that contains protons...；1.3 Electrons, energy levels and atomic orbitals
In 1.3 each atom or ion described will be in the ground state. Only the elements hydrogen to krypton will be assessed.
Learning outcomes
Candidates sho...；1.4 Ionisation energy
In 1.4 each atom or ion described will be in the ground state. Only the elements hydrogen to krypton will be assessed.
Learning outcomes
Candidates should be able to:
1 define an...
