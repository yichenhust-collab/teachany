...
<!-- TeachAny KP: kp_id=kp-chemistry-cam-igcse-redox node_id=chemistry-cam-igcse-redox subject=chemistry stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-cam-igcse-redox` |
| node_id | `chemistry-cam-igcse-redox` |
| 知识点 | 氧化还原 |
| 英文名 | Redox |
| 学科 | 化学 (chemistry) |
| 学段 | IGCSE (igcse) |
...
- `chemistry-cam-igcse-reaction-types`
...
S phase of the cell cycle, including:
• the roles of DNA polymerase and DNA ligase (knowledge
of other enzymes in DNA replication in cells ...；describe the structure of an RNA molecule, using the example
of messenger RNA (mRNA)
