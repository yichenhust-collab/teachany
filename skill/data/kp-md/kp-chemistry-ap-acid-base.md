...
<!-- TeachAny KP: kp_id=kp-chemistry-ap-acid-base node_id=chemistry-ap-acid-base subject=chemistry stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-ap-acid-base` |
| node_id | `chemistry-ap-acid-base` |
| 知识点 | 酸碱理论 |
| 英文名 | Acid-base theories |
| 学科 | 化学 (chemistry) |
| 学段 | 高中 (high) |
| 年级 | 12 |
| 课标系统 | AP 大学先修 |
