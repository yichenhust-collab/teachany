# 细胞分室化 / Compartmentalization

<!-- TeachAny KP: kp_id=kp-biology-ap-compartmentalization node_id=biology-ap-compartmentalization subject=biology stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-biology-ap-compartmentalization` |
| node_id | `biology-ap-compartmentalization` |
| 知识点 | 细胞分室化 |
| 英文名 | Compartmentalization |
| 学科 | 生物 (biology) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 大学先修 |
| 领域 | Unit 1-2 分子与细胞 Molecular & Cell |
...
- `biology-ap-cell-structure`

## 课标摘要

1.6.A.1
In nucleic acids (DNA and RNA), biological information is encoded in sequences of nucleotide monomers. Each nucleotide has the following structural components: a five-carbon sugar (deoxyribose...；1.6.A.3
DNA is structured as an antiparallel double helix, with two strands of nucleotides running in opposite 5’ to 3’ orientation. In DNA, adenine nucleotides pair with thymine nucleotides via hydro...；1.6.A.4
Structural differences between DNA and RNA include:
i. DNA contains the sugar deoxyribose, and RNA contains the sugar ribose.
ii. DNA contains the nitrogenous base thymine, and RNA contains th...
