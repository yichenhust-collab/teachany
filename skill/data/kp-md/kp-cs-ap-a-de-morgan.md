...
<!-- TeachAny KP: kp_id=kp-cs-ap-a-de-morgan node_id=cs-ap-a-de-morgan subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-de-morgan` |
| node_id | `cs-ap-a-de-morgan` |
| 知识点 | 德摩根定律 |
| 英文名 | De Morgan's laws |
| 学科 | 计算机 (cs) |
| 学段 | 高中 (high) |
| 年级 | 10 |
| 课标系统 | AP 大学先修 |
