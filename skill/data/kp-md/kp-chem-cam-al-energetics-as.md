# 5 能量学（焓变/键能/Hess 定律） / 5 Chemical energetics

<!-- TeachAny KP: kp_id=kp-chem-cam-al-energetics-as node_id=chem-cam-al-energetics-as subject=chemistry stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chem-cam-al-energetics-as` |
| node_id | `chem-cam-al-energetics-as` |
| 知识点 | 5 能量学（焓变/键能/Hess 定律） |
| 英文名 | 5 Chemical energetics |
| 学科 | 化学 (chemistry) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
