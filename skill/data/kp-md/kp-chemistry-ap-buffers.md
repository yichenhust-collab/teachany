# 缓冲溶液 / Buffers & titration

<!-- TeachAny KP: kp_id=kp-chemistry-ap-buffers node_id=chemistry-ap-buffers subject=chemistry stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-ap-buffers` |
| node_id | `chemistry-ap-buffers` |
| 知识点 | 缓冲溶液 |
| 英文名 | Buffers & titration |
| 学科 | 化学 (chemistry) |
| 学段 | 高中 (high) |
| 年级 | 12 |
| 课标系统 | AP 大学先修 |
| 领域 | Unit 7-8 平衡与酸碱 Equilibrium & Acid-Base |
