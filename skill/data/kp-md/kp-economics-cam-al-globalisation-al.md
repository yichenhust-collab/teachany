...
<!-- TeachAny KP: kp_id=kp-economics-cam-al-globalisation-al node_id=economics-cam-al-globalisation-al subject=economics stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-economics-cam-al-globalisation-al` |
| node_id | `economics-cam-al-globalisation-al` |
| 知识点 | 全球化 |
| 英文名 | Globalisation |
| 学科 | 经济 (economics) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
| 领域 | 国际经济 / International Economics / International Economics |
...
- `economics-cam-al-intl-trade-al`

## 课标摘要

2.2 Price elasticity, income elasticity and cross elasticity of demand
2.2.1 definition of price elasticity, income elasticity and cross elasticity of demand (PED, YED, XED)
2.2.2 formulae for and cal...；2.2.6 factors affecting:
• price elasticity of demand
• income elasticity of demand
• cross elasticity of demand；2.2.8 implications for decision-making of price elasticity, income elasticity and cross elasticity of demand
