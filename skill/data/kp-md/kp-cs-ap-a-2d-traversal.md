# 二维遍历 / 2D array traversal

<!-- TeachAny KP: kp_id=kp-cs-ap-a-2d-traversal node_id=cs-ap-a-2d-traversal subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-2d-traversal` |
| node_id | `cs-ap-a-2d-traversal` |
| 知识点 | 二维遍历 |
| 英文名 | 2D array traversal |
| 学科 | 计算机 (cs) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 大学先修 |
| 领域 | Unit 7-8 集合与二维 ArrayList & 2D |
