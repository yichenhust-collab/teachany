# 文章组织 / Organization & coherence

<!-- TeachAny KP: kp_id=kp-english-ap-organization node_id=english-ap-organization subject=english stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-ap-organization` |
| node_id | `english-ap-organization` |
| 知识点 | 文章组织 |
| 英文名 | Organization & coherence |
| 学科 | 英语 (english) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 大学先修 |
...
Students evaluate, synthesize, and cite research to support their arguments.
