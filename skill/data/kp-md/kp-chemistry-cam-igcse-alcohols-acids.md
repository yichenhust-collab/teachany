# 醇与有机酸 / Alcohols & carboxylic acids

<!-- TeachAny KP: kp_id=kp-chemistry-cam-igcse-alcohols-acids node_id=chemistry-cam-igcse-alcohols-acids subject=chemistry stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-cam-igcse-alcohols-acids` |
| node_id | `chemistry-cam-igcse-alcohols-acids` |
| 知识点 | 醇与有机酸 |
| 英文名 | Alcohols & carboxylic acids |
| 学科 | 化学 (chemistry) |
| 学段 | IGCSE (igcse) |
| 年级 | 10 |
| 课标系统 | 剑桥国际课程 |
| 领域 | 有机化学与其他 / Organic & Other / Organic & Other |
...
- `chemistry-cam-igcse-alkanes-alkenes`
...
the 5′ to 3′ strand and the 3′ to 5′ strand (antiparallel
strands)
• diffe...；describe the semi-conservative replication of DNA during the
S phase of the cell cycle, including:
• the roles of DNA polymerase and DNA ligase (knowledge
of other enzymes in DNA replication in cells ...
