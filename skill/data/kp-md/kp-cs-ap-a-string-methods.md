...
<!-- TeachAny KP: kp_id=kp-cs-ap-a-string-methods node_id=cs-ap-a-string-methods subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-string-methods` |
| node_id | `cs-ap-a-string-methods` |
| 知识点 | 字符串方法 |
| 英文名 | String methods |
| 学科 | 计算机 (cs) |
| 学段 | 高中 (high) |
