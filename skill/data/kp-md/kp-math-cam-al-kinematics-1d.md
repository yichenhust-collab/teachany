# M1.1 一维运动学 / M1.1 Kinematics (linear)

<!-- TeachAny KP: kp_id=kp-math-cam-al-kinematics-1d node_id=math-cam-al-kinematics-1d subject=math stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-cam-al-kinematics-1d` |
| node_id | `math-cam-al-kinematics-1d` |
| 知识点 | M1.1 一维运动学 |
| 英文名 | M1.1 Kinematics (linear) |
| 学科 | 数学 (math) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
