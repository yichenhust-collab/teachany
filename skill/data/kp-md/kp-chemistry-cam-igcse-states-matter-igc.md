...
<!-- TeachAny KP: kp_id=kp-chemistry-cam-igcse-states-matter-igc node_id=chemistry-cam-igcse-states-matter-igc subject=chemistry stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-cam-igcse-states-matter-igc` |
| node_id | `chemistry-cam-igcse-states-matter-igc` |
| 知识点 | 物态变化 |
| 英文名 | States of matter |
| 学科 | 化学 (chemistry) |
| 学段 | IGCSE (igcse) |
| 年级 | 9 |
| 课标系统 | 剑桥国际课程 |
