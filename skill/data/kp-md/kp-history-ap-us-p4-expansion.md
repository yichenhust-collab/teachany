# 1800-1848 扩张与改革 / Period 4: Expansion & reform

<!-- TeachAny KP: kp_id=kp-history-ap-us-p4-expansion node_id=history-ap-us-p4-expansion subject=us-history stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-history-ap-us-p4-expansion` |
| node_id | `history-ap-us-p4-expansion` |
| 知识点 | 1800-1848 扩张与改革 |
| 英文名 | Period 4: Expansion & reform |
| 学科 | 美国史 (us-history) |
| 学段 | 高中 (high) |
| 年级 | 11 |
| 课标系统 | AP 大学先修 |
...
- `history-ap-us-constitution`

## 课标摘要

KC-5.3.II.i
Reconstruction and the Civil War ended slavery, altered relationships between the states and the federal government, and led to debates over new definitions of citizenship, particularly re...；KC-5.3.II.A
The 13th Amendment abolished slavery, while the 14th and 15th amendments granted African Americans citizenship, equal protection under the laws, and voting rights.；KC-5.3.II.C
Efforts by radical and moderate Republicans to change the balance of power between Congress and the presidency and to reorder race relations in the defeated South yielded some short-term s...；KC-5.3.II.E
Segregation, violence, Supreme Court decisions, and local political tactics progressively stripped away African American rights, but the 14th and 15th amendments eventually became the basi...
