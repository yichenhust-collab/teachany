...
<!-- TeachAny KP: kp_id=kp-chemistry-cam-igcse-mole node_id=chemistry-cam-igcse-mole subject=chemistry stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-cam-igcse-mole` |
| node_id | `chemistry-cam-igcse-mole` |
| 知识点 | 摩尔 |
| 英文名 | The mole |
| 学科 | 化学 (chemistry) |
| 学段 | IGCSE (igcse) |
...
- `chemistry-cam-igcse-atoms-elements-igc`
