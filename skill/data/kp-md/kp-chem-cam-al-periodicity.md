# 9 周期性（第 3 周期） / 9 Chemistry of the Periodic Table

<!-- TeachAny KP: kp_id=kp-chem-cam-al-periodicity node_id=chem-cam-al-periodicity subject=chemistry stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chem-cam-al-periodicity` |
| node_id | `chem-cam-al-periodicity` |
| 知识点 | 9 周期性（第 3 周期） |
| 英文名 | 9 Chemistry of the Periodic Table |
| 学科 | 化学 (chemistry) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
| 领域 | AS 无机化学 Inorganic Chemistry |
