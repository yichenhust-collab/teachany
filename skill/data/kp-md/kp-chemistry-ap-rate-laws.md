# 速率方程 / Rate laws & orders

<!-- TeachAny KP: kp_id=kp-chemistry-ap-rate-laws node_id=chemistry-ap-rate-laws subject=chemistry stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-ap-rate-laws` |
| node_id | `chemistry-ap-rate-laws` |
| 知识点 | 速率方程 |
| 英文名 | Rate laws & orders |
| 学科 | 化学 (chemistry) |
| 学段 | 高中 (high) |
| 年级 | 12 |
| 课标系统 | AP 大学先修 |
| 领域 | Unit 5-6 动力学与热力学 Kinetics & Thermodynamics |
...
- `chemistry-ap-reaction-rates`

## 课标摘要

1.5.A Represent the ground-state electron configuration of an atom of an element or its ions using the Aufbau principle.；1.5.A.2 Coulomb’s law is used to calculate the force between two charged particles.
qq
F ∝ 1 2
EQN: coulombic r2；1.5.A.3 In atoms and ions, the electrons can be thought of as being in “shells (energy levels)” and “subshells (sublevels),” as described by the ground-state electron configuration. Inner electrons ar...；1.5.A.4 The relative energy required to remove an electron from different subshells of an atom or ion or from the same subshell in different atoms or ions (ionization energy) can be estimated through ...
