# while 与 for 循环 / while & for loops

<!-- TeachAny KP: kp_id=kp-cs-ap-a-while-for node_id=cs-ap-a-while-for subject=cs stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-cs-ap-a-while-for` |
| node_id | `cs-ap-a-while-for` |
| 知识点 | while 与 for 循环 |
| 英文名 | while & for loops |
| 学科 | 计算机 (cs) |
| 学段 | 高中 (high) |
