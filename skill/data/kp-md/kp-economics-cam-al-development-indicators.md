...
<!-- TeachAny KP: kp_id=kp-economics-cam-al-development-indicators node_id=economics-cam-al-development-indicators subject=economics stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-economics-cam-al-development-indicators` |
| node_id | `economics-cam-al-development-indicators` |
| 知识点 | 发展指标 |
| 英文名 | Development indicators |
| 学科 | 经济 (economics) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
