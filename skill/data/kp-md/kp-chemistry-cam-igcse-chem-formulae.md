# 化学式与方程 / Formulae & equations

<!-- TeachAny KP: kp_id=kp-chemistry-cam-igcse-chem-formulae node_id=chemistry-cam-igcse-chem-formulae subject=chemistry stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-chemistry-cam-igcse-chem-formulae` |
| node_id | `chemistry-cam-igcse-chem-formulae` |
| 知识点 | 化学式与方程 |
| 英文名 | Formulae & equations |
| 学科 | 化学 (chemistry) |
| 学段 | IGCSE (igcse) |
| 年级 | 10 |
| 课标系统 | 剑桥国际课程 |
| 领域 | 定量化学 / Stoichiometry / Stoichiometry |
