# 扩散与渗透 / Diffusion & osmosis

<!-- TeachAny KP: kp_id=kp-biology-cam-igcse-diffusion-osmosis node_id=biology-cam-igcse-diffusion-osmosis subject=biology stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-biology-cam-igcse-diffusion-osmosis` |
| node_id | `biology-cam-igcse-diffusion-osmosis` |
| 知识点 | 扩散与渗透 |
| 英文名 | Diffusion & osmosis |
| 学科 | 生物 (biology) |
| 学段 | IGCSE (igcse) |
| 年级 | 10 |
| 课标系统 | 剑桥国际课程 |
