...
<!-- TeachAny KP: kp_id=kp-math-ap-cab-riemann-sum node_id=math-ap-cab-riemann-sum subject=calculus-ab stage=high -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-math-ap-cab-riemann-sum` |
| node_id | `math-ap-cab-riemann-sum` |
| 知识点 | 黎曼和 |
| 英文名 | Riemann sums |
