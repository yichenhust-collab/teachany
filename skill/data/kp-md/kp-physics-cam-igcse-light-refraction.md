# 光与折射 / Light & refraction

<!-- TeachAny KP: kp_id=kp-physics-cam-igcse-light-refraction node_id=physics-cam-igcse-light-refraction subject=physics stage=igcse -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-physics-cam-igcse-light-refraction` |
| node_id | `physics-cam-igcse-light-refraction` |
| 知识点 | 光与折射 |
...
- `physics-cam-igcse-wave-properties`
