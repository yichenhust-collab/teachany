# 非文学文本 / Non-literary texts

<!-- TeachAny KP: kp_id=kp-english-cam-al-non-literary-texts node_id=english-cam-al-non-literary-texts subject=english stage=al -->

## 元数据

| 字段 | 值 |
| --- | --- |
| kp_id | `kp-english-cam-al-non-literary-texts` |
| node_id | `english-cam-al-non-literary-texts` |
| 知识点 | 非文学文本 |
| 英文名 | Non-literary texts |
| 学科 | 英语 (english) |
| 学段 | al (al) |
| 年级 | 12 |
| 课标系统 | 剑桥国际课程 |
| 领域 | 文体与非文学 / Stylistics & Non-Literary / Stylistics & Non-Literary |
...
- `english-cam-al-stylistic-analysis`

## 课标摘要

The aims are to enable students to:
• enjoy the experience of reading literature
• develop an appreciation of and an informed personal response to literature in English in a range of texts in differen...；The key concepts for Cambridge International AS & A Level Literature in English are:
• Language
Exploring the variety and use of language in literary texts. Identifying literary techniques and explain...；The assessment objectives (AOs) are:
AO1 Knowledge and understanding
